package com.spring.demo.unitaire;

import com.spring.demo.domaine.ArticleDTO;
...
class ArticleControllerTest {
    ...
    void testGetAll() throws Exception {
        ...
        mvc.perform(get("/api/articles/all").contentType(String.valueOf(MediaType.APPLICATION_JSON)).accept(String.valueOf(MediaType.APPLICATION_JSON)))
